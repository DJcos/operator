...
* [Architecture](https://github.com/minio/operator/blob/master/README.md#Architecture)
* [Create a MinIO Tenant](https://github.com/minio/operator/blob/master/README.md#Create-a-MinIO-Tenant)
* [Expand a MinIO Tenant](https://github.com/minio/operator/blob/master/REAMDE.md#Expand-a-MinIO-Tenant)
* [Kubernetes Cluster Configuration](https://github.com/minio/operator/blob/master/README.md#Kubernetes-Cluster-Configuration)
...
- The `--storageClassName` field indicates which `StorageClass` to use when generating
  each `PVC``.
